...
My PFLD copying implementation for 98 facial landmarks detector based on [pfld_106_face_landmarks](https://github.com/Hsintao/pfld_106_face_landmarks.git).
...
~~~shell
$ CUDA_VISIBLE_DEVICES=0 python3 train.py --backbone=ghost
~~~
...
https://github.com/Hsintao/pfld_106_face_landmarks.git
